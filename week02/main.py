...
combatStrength += weaponRoll  # Add weaponRoll to hero's combat strength
print(f"You rolled {weaponRoll}. Your weapon is: {weapon}")

# Weapon roll conditions
if weaponRoll <= 2:
...
print("Your weapon (" + weapon + " - Strength: " + str(combatStrength) + ") ---> Monster (" + str(mHealthPoints) + ")")
